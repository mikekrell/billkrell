    ...
    return (
            ...
            <div class="card p-3">
                    <div class="card-image">
                        ...
                        <span className={equip.fields.price == 0 ? 'tag is-pulled-right has-background-warning is-medium' : 'tag is-pulled-right has-background-success has-text-white-ter is-medium' }>
                    ...
                    <p className="is-size-6 has-text-white image-manufacture-title"><span className="has-text-weight-bold">{equip.fields.year}</span> {equip.fields.manufacture}</p>
                        <h1 className="is-size-4 has-text-white has-text-weight-bold">{equip.fields.title}</h1>
                    </span>
                </div>
            </div>
    )
