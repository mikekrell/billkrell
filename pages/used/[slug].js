    ...
    return (
        <>
            <Head>
                ...
                <meta prefix="og: http://ogp.me/ns#" property="og:title" content={equipment[0].fields.price == 0 ? `${equipment[0].fields.year} ${equipment[0].fields.manufacture} ${equipment[0].fields.title} | Feenaughty` : `${equipment[0].fields.year} ${equipment[0].fields.manufacture} ${equipment[0].fields.title} | ${formatter.format(equipment[0].fields.price)}`} key="ogtitle" />
                <meta prefix="og: http://ogp.me/ns#" property="og:image" content={getImageUrl(equipment[0])} />
                <meta prefix="og: http://ogp.me/ns#" property="og:description" content={equipment[0].fields.description} />
